...
RUNNING = [load_img("image", "DUCK_RUN1.PNG", (85,110)), 
           load_img("image", "DUCK_RUN2.PNG", (85,110))]
JUMPING = load_img("image", "DUCK_JUMP.PNG", (85,110))
SLIDING = [load_img("image", "DUCK_SLIDE1.PNG", (86,82)), 
...
SMALL_OBT = [load_img("image", "OBT1-1.PNG", (76,90)), 
             load_img("image", "OBT1-2.PNG", (54,90)), 
             load_img("image", "OBT1-3.PNG", (90,90))]
LARGE_OBT = [load_img("image", "OBT2-1.PNG", (82,145)), 
